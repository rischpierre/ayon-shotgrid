...
import os
from shogun_api3 import Shotgun
...
sg = Shotgun(sg_url, script_name=script_name, api_key=script_key, http_proxy=proxy_url)

schema_path = "schema.bin"
entity_schema_path = "schema_entity.bin"

mockgun.generate_schema(sg, schema_path, entity_schema_path)
